...
# ------------------------------------------------------------------------
# Modified from FUTR3D (https://github.com/Tsinghua-MARS-Lab/futr3d)
# Copyright (c) 2022 Chen, Xuanyao
# ------------------------------------------------------------------------
...
if __name__ == '__main__':
    create_nuscenes_infos('/data/datasets/nuScenes/', 'radar_nuscenes_5sweeps', version='v1.0-trainval')